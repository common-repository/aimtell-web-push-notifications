...
We've powered hundreds of billions of website push notifications for 20,000+ sites and it's quickly becoming one of the most powerful re-engagement tools out there. Join Aimtell today and find out what you've been missing!

About Aimtell: Web Push Notifications
====================================
...
Trusted By Over 20,000 Sites
----------------------------

We've powered hundreds of billions of website push notifications for over 20,000 sites with current users including Home Depot, Groupon, Shopify, Spartan Races, Rhone, Run The Jewels, Dolly Parton, Lotd, Radware, American Home Shield, Death Wish Coffee and many more.
...
**Supported on:**
Aimtell's Push Notifications are supported every website push notification supported browser on Desktop and Mobile (Android & iOS) including: 
* Chrome
* Safari 
* Edge
* Firefox 
...
We support Safari(Desktop and Mobile on iOS), Firefox(Desktop), Chrome(Desktop and Mobile on Android) and Opera (Android). Essentially all browsers that offer the new Web Push Technology are supported.
...
5. Android - Mobile Notification Example
